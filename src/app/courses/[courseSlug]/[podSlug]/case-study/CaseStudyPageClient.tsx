...
import {
  isPodCaseStudyComplete,
  markPodCaseStudyComplete,
} from '@/lib/progress';
...
export default function CaseStudyPageClient({
  ...
  useEffect(() => {
    setCompleted(isPodCaseStudyComplete(courseSlug, podSlug));
  }, [courseSlug, podSlug]);

  const handleMarkComplete = () => {
    markPodCaseStudyComplete(courseSlug, podSlug);
    setCompleted(true);
  };
        ...
        <FadeIn delay={0.3}>
          <div className="mt-6">
            <CourseNav
              ...
              nextHref={completed ? `${basePath}/certificate` : undefined}
