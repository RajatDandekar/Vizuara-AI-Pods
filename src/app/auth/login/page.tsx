      ...
      <FadeIn className="w-full max-w-md">
        <div className="bg-card-bg border border-card-border rounded-2xl p-8 shadow-sm">
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center gap-2 cursor-pointer">
                <input
                  ...
                  className="w-4 h-4 rounded border-card-border text-accent-blue focus:ring-accent-blue/30"
                />
                <span className="text-sm text-text-secondary">Remember me</span>
              </label>
              <Link href="/auth/forgot-password" className="text-sm text-accent-blue hover:underline">
                Forgot password?
              </Link>
            </div>
          ...
          <p className="text-center text-sm text-text-secondary mt-6">
            ...
            <Link href="/auth/signup" className="text-accent-blue hover:underline font-medium">
              Sign up
            </Link>
          </p>
        </div>
