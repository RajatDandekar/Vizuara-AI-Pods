    ...
    <div className="light-landing min-h-screen" style={{ background: '#fafafa' }}>
      ...
      {!user && (
        <div className="relative max-w-6xl mx-auto px-4 sm:px-6 pb-16 space-y-16" style={{ zIndex: 1 }}>
          ...
          <FadeIn delay={0.25}>
            <div className="text-center mb-8">
              <h2 className="text-2xl sm:text-3xl font-bold text-slate-900 mb-2">Who is this for?</h2>
              <p className="text-base text-slate-500 max-w-lg mx-auto">
                Whether you&apos;re learning, publishing, or deploying &mdash; Vizuara meets you where you are.
              </p>
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
              <div className="glass-card rounded-2xl p-6 flex flex-col">
                ...
                <h3 className="font-bold text-slate-900 text-lg mb-2">Students</h3>
                <ul className="space-y-2 text-base text-slate-700 leading-relaxed">
                  <li className="flex items-start gap-2">
                    <span className="text-blue-400 mt-0.5">&#8250;</span>
                    Build every concept from scratch in Colab &mdash; no black-box libraries
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-blue-400 mt-0.5">&#8250;</span>
                    Guided TODO exercises that test real understanding, not memorization
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-blue-400 mt-0.5">&#8250;</span>
                    Earn certificates to showcase on your resume and LinkedIn
                  </li>
                </ul>
              </div>
              <div className="glass-card rounded-2xl p-6 flex flex-col">
                ...
                <h3 className="font-bold text-slate-900 text-lg mb-2">Researchers</h3>
                <ul className="space-y-2 text-base text-slate-700 leading-relaxed">
                  <li className="flex items-start gap-2">
                    <span className="text-purple-400 mt-0.5">&#8250;</span>
                    Articles derive every equation from first principles with full mathematical rigor
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-purple-400 mt-0.5">&#8250;</span>
                    Covers cutting-edge topics like diffusion LLMs, VLAs, and world models within weeks of publication
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-purple-400 mt-0.5">&#8250;</span>
                    Reproduce key results from landmark papers in runnable notebooks
                  </li>
                </ul>
              </div>
              <div className="glass-card rounded-2xl p-6 flex flex-col">
                ...
                <h3 className="font-bold text-slate-900 text-lg mb-2">Industry Professionals</h3>
                <ul className="space-y-2 text-base text-slate-700 leading-relaxed">
                  <li className="flex items-start gap-2">
                    <span className="text-emerald-400 mt-0.5">&#8250;</span>
                    Case studies frame every concept as a real business problem with production constraints
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-emerald-400 mt-0.5">&#8250;</span>
                    Go from theory to working prototype in hours, not weeks
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-emerald-400 mt-0.5">&#8250;</span>
                    Stay current with the latest architectures without wading through papers
                  </li>
                </ul>
              </div>
            </div>
