      ...
      <div className={`relative rounded-2xl overflow-hidden ${!unlocked ? 'opacity-60' : ''}`}>
        ...
        <div className="relative bg-card-bg border border-amber-200/60 rounded-2xl p-6 sm:p-8">
          ...
          <div className="flex items-start gap-4 mb-6">
            <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-accent-amber-light to-accent-amber-light border border-amber-200/60 flex items-center justify-center flex-shrink-0">
              {unlocked ? (
          ...
          {unlocked ? (
            <Link href={`/courses/${slug}/case-study`}>
              <motion.div
                ...
                className="bg-gradient-to-br from-surface-secondary to-accent-amber-light/30 border border-card-border rounded-xl p-5 sm:p-6 cursor-pointer hover:shadow-md hover:border-amber-300/50 transition-all"
              >
            ...
            <div className="bg-surface-secondary border border-card-border rounded-xl p-5 sm:p-6">
              <CaseStudyCardContent caseStudy={caseStudy} />
            </div>
          )}
    ...
    <>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
        <div className="flex items-center gap-2.5 text-sm text-text-secondary">
          <div className="w-7 h-7 rounded-lg bg-accent-blue-light flex items-center justify-center flex-shrink-0">
        ...
        <div className="flex items-center gap-2.5 text-sm text-text-secondary">
          <div className="w-7 h-7 rounded-lg bg-accent-green-light flex items-center justify-center flex-shrink-0">
